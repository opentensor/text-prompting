...
Bittensor LM 3B Language Model
This code is for running the very small (but poweful!) Bittensor Language Model created by Cerebras.  

# Example Usage
```
python3 neurons/miners/bittensorLM/miner.py
```
